  ...
  return (
      <section className='bg-fuchsia-950 py-10 max-w-7xl mx-4 my-2 md:mx-auto'>
          <div className='container max-w-6xl mx-auto py-6 px-4'>
              <div className='grid sm:grid-rows-1 md:grid-cols-2 gap-3 space-y-3 md:space-y-0 items-center justify-center md:justify-between'>
                  <div className='bg-white/10 rounded-2xl backdrop-blur-xl p-4 overflow-hidden'>
                  ...
                  <div className='mt-4'>
                      ...
                      <div className='grid grid-rows-1 md:grid-cols-2 items-stretch gap-4 my-3'>
                          ...
                          <div className='block mt-3 md:mt-0'>
                              ...
                              <div className='flex flex-row items-center space-x-3 justify-between w-full rounded-md px-4 py-3 text-white bg-white/10'>
                                  <p className='font-serif'>Select</p>
              ...
              <div className='h-full bg-white/30 rounded-2xl backdrop-blur-xl p-4 overflow-hidden'>
                  ...
                  <div className='mt-4'>
                      ...
                      <p className='rounded-sm w-full px-2 py-1 my-3 bg-gradient-to-r from-blue-600/50 to-white/50'></p>
                      <div className='flex flex-row items-center space-x-3 justify-between w-full rounded-md px-4 py-3 bg-white my-3'>
